    ...
    <div className="h-screen flex flex-col bg-white overflow-hidden">
      ...
      <header className="flex flex-col sm:flex-row sm:items-center gap-2 px-3 py-2 border-b border-green-100 bg-white shrink-0 shadow-sm">
        ...
        <div className="flex items-center gap-2 sm:ml-auto flex-wrap">
          ...
          <button onClick={() => setWorkOpen(true)}
            title="Look at what each student is working on"
            ...
            <PenSquare size={12} /> Student Work
          </button>
      ...
      <div className="flex-1 flex min-h-0">
        <div className="flex-1 min-w-0 flex flex-col">
          ...
          <div className={tab === 'notes' ? 'flex-1 min-h-0' : 'hidden'}><RichTextEditor sessionId={id!} isTeacher canEdit /></div>
        </div>
      ...
      {workOpen && <StudentWorkPanel sessionId={id!} onClose={() => setWorkOpen(false)} />}
