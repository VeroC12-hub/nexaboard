-- ============================================================================
-- Demonstration school and role assignment.
--
-- The six auth users already exist. This attaches them to Wesley Girls' and
-- gives each the role that decides which application they see. Idempotent, so
-- re-running is safe.
-- ============================================================================
